...
```{r, echo=FALSE, message=FALSE, warning = FALSE, fig.height=3.1, fig.width=6.2, out.width=800, dpi=200}
    ...
    plot = function(df, style = style_SAR_CCDR()) {
      ...
      p.poverty <- ggplot(df.poverty, aes(x = date, group = rev(iso3c), color = iso3c)) +
        ...
        scale_y_continuous(
          ...
          expand=c(0.35,0)) +
        annotate("text", x = 2015, y = 30, label = "South Asia", size = 2.5, family = style$family, color = style$colors$text) +
        scale_color_manual(values = color_list) +
...
figure_save_draft_png(fig_ch1_economic_growth_and_poverty_var1(), style_SAR_CCDR, "../png/fig_ch1_economic_growth_and_poverty_var1.png", height=3.1, width=6.2)
...
fig_ch1_natural_disaster_frequency <- function() {
  ...
  figure(
    ...
    source = "Source: EM-DAT The International Disasters Database"
  )
}
...
fig_ch1_recent_natural_disaster_var1 <- function() {
  ...
  figure(
    ...
    plot = function(df, style = style_SAR_CCDR()) {
      ...
      df.category$label <- paste0(df.category$category, "\n(", df.category$category_frequency, ")")
      df.category$label <- c("Meteorological\n(79)", "Hydrological\n(45)", "Biological\n(9)", "Geophysical\n(5)", "" )
      df.category$vjust <- c(0.5, 0.5, 0.7, 0.1, 0.0)
      ...
      p.frequency <- ggplot() +
        geom_rect(data=df.category, aes(ymax=ymax, ymin=ymin, xmax=3.5, xmin=2, fill=category), color = "white", size=1) +
        geom_rect(data=df.type, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3.5, fill=category), color = "white", size=1, alpha = 0.4) +
        geom_text(data = df.category, x=2.8, aes(y = labelPosition, label = label, vjust=vjust, family=style$family), size=2.2, lineheight = .9) +
        geom_text(data = df.type, x=4.1, aes(y = labelPosition, label = label, angle=angle, hjust=hjust, family=style$family), size=2, lineheight = .9, show.legend = F) + 
        coord_polar(theta="y") +
        xlim(c(1, 5.1)) +
        scale_fill_manual(values = color_list)+
        annotate(geom = 'text', x = 1, y = 0, label = "Frequency", size=3) +
        labs(subtitle = "Frequency of natural disasters")+
        style$theme() +
        theme(legend.position = "none",
      ...
      df.category$label <- paste0(df.category$category, "\n(", prettyNum(df.category$category_deaths,big.mark=","), ")")
      df.category$label <- c("Meteorological\n(7,762)","Hydrological\n(3,600)","Biological\n(260)","","" )
      df.category$vjust <- c(0.5, 0.8, -0.3, 0.5, 0.5)
      ...
      df.type$label <- c("Storm", "Extreme temp.", "Flood", "Landslide", "Epidemic", "", "")
      df.type$hjust <- c(0, 1, 1, 1, 1, 1, 1)
  
      p.deaths <- ggplot() +
        geom_rect(data=df.category, aes(ymax=ymax, ymin=ymin, xmax=3.5, xmin=2, fill=category), color = "white", size=1) +
        geom_rect(data=df.type, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3.5, fill=category), color = "white", size=1, alpha = 0.4) +
        geom_text(data = df.category, x=2.6, aes(y = labelPosition, label = label, vjust=vjust, family=style$family), size=2.2, lineheight = .9) +
        geom_text(data = df.type, x=4.1, aes(y = labelPosition, label = label, angle=angle, hjust=hjust, family=style$family), size=2, lineheight = .9, show.legend = F) + 
        coord_polar(theta="y") +
        xlim(c(1, 5.1)) +
        scale_fill_manual(values = color_list)+
        annotate(geom = 'text', x = 1, y = 0, label = "Deaths", size=3) +
        labs(subtitle = "Total deaths from natural disasters")+
        style$theme() +
        theme(legend.position = "none",
              plot.subtitle=element_text(hjust=0.5),
              panel.grid.major.x = element_blank(),
      ...
      df.category$label <- paste0(df.category$category, "\n(", prettyNum(df.category$category_damage,big.mark=","), ")")
      df.category$label <- c("Hydrological\n(5,787,291)", "Meteorological\n(5,674,392)", "Geophysical\n(717,294)", "", "")
      df.category$hjust <- c(0.4, 0.6, 0.5, 1, 1)
      ...
      p.damage <- ggplot() +
        geom_rect(data=df.category, aes(ymax=ymax, ymin=ymin, xmax=3.5, xmin=2, fill=category), color = "white", size=1) +
        geom_rect(data=df.type, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3.5, fill=category), color = "white", size=1, alpha = 0.4) +
        geom_text(data = df.category, x=2.6, aes(y = labelPosition, label = label, hjust=hjust, family=style$family), size=2.2, lineheight = .9, box.padding = unit(0, "lines"), 
                  show.legend = F) +
        geom_text(data = df.type, x=4.1, aes(y = labelPosition, label = label, angle=angle, hjust=hjust, family=style$family), size=2, lineheight = .9, show.legend = F) + 
        coord_polar(theta="y") +
        xlim(c(1, 5.1)) +
        ...
        labs(subtitle = "Total damages from natural disasters, adjusted ('000 US$)")+
        style$theme() +
        theme(legend.position = "none",
              plot.subtitle=element_text(hjust=0.5),
              panel.grid.major.x = element_blank(),
...
figure_save_draft_png(fig_ch1_recent_natural_disaster_var1(), style_SAR_CCDR, "../png/fig_ch1_recent_natural_disaster_var1.png", height=4.1, width=8.5)
  ...
  figure(
    ...
    plot = function(df, style = style_SAR_CCDR()) {
      ...
      p.frequency <- ggplot() +
        ...
        xlim(c(1, 5.1)) +
        scale_fill_manual(values = color_list)+
        annotate(geom = 'text', x = 1, y = 0, label = "Frequency", size=3, family=style$family) +
        labs(subtitle = "Frequency of natural disasters")+
        style$theme() +
        theme(legend.position = "none",
              plot.subtitle=element_text(hjust=0.5),
      ...
      p.deaths <- ggplot() +
        ...
        xlim(c(1, 5.1)) +
        scale_fill_manual(values = color_list)+
        annotate(geom = 'text', x = 1, y = 0, label = "Deaths", size=3, family=style$family) +
        labs(subtitle = "Total deaths from natural disasters")+
        style$theme() +
        theme(legend.position = "none",
              plot.subtitle=element_text(hjust=0.5),
      ...
      p.damage <- ggplot() +
        ...
        xlim(c(1, 5.1)) +
        scale_fill_manual(values = color_list)+
        annotate(geom = 'text', x = 1, y = 0, label = "Damage", size=3, family=style$family) +
        labs(subtitle = "Total damages from natural disasters, adjusted ('000 US$)")+
        style$theme() +
        theme(legend.position = "none",
              plot.subtitle=element_text(hjust=0.5),
...
figure_save_draft_png(fig_ch1_recent_natural_disaster_var2(), style_SAR_CCDR, "../png/fig_ch1_recent_natural_disaster_var2.png", height=4.1, width=8.5)
...
```{r, echo=FALSE, message=FALSE, warning = FALSE, fig.height=4.1, fig.width=7.2, out.width=800, dpi=200}

library(ggradar)
library(zoo)

fig_ch1_vulnerability_readiness_var1 <- function() {
  ...
  figure(
    ...
    note = "Note: Vulnerability measures a country's exposure, sensitivity and ability to adapt to the negative impact of climate change nwhile Readiness measures a country’s ability to leverage investments and convert them to adaptation actions.",
    source = "Source: The Notre Dame-Global Adaptation Index (ND-GAIN) Country Index."
  )
}

fig_ch1_vulnerability_readiness_var1()

figure_save_draft_png(fig_ch1_vulnerability_readiness_var1(), style_SAR_CCDR, "../png/fig_ch1_vulnerability_readiness_var1.png", height=4.1, width=7.2)
...
fig_ch1_vulnerability_readiness_var2 <- function() {
...
fig_ch1_vulnerability_readiness_var2()

figure_save_draft_png(fig_ch1_vulnerability_readiness_var2(), style_SAR_CCDR, "../png/fig_ch1_vulnerability_readiness_var2.png", height=4.1, width=7.2)
