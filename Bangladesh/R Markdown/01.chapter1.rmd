...
fig_ch1_GHG_emissions_pie <- function() {
  ...
  df$label <- paste0(gsub("Land-Use Change and Forestry", "Land-Use Change\nand Forestry", df$Sector), "\n", round(df$percentage,1), "%")
...
fig_ch1_GHG_emissions_line_pie <- function() {
  ...
  figure(
    ...
    plot = function(df, style = style_SAR_CCDR()) {
      ...
      df.pie$label <- paste0(gsub("Land-Use Change and Forestry", "Land-Use Change\nand Forestry", df.pie$Sector), "\n", round(df.pie$percentage,1), "%")
