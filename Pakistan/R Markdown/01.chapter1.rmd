    ...
    plot = function(df.poverty, style = style_SAR_CCDR()) {
      ggplot(df.poverty, aes(x = date, group = rev(iso3c), color = iso3c)) +
        ...
        scale_y_continuous(
          ...
          expand=c(0.1,0)) +
        annotate("text", x = 2013, y = 70, label = "South Asia", size = 2.5, family = style$family, color = style$colors$text) +
        scale_color_manual(values = color_list) +
        style$theme()
    },
    aspect_ratio = 1,
    # title = "Pakistan's poverty compared with South Asia and lower-middle-income group",
    subtitle = "Poverty headcount ratio at $3.20 a day (2011 PPP) (% of population)",
...
figure_save_draft_png(fig_ch1_poverty_var2(), style_SAR_CCDR, "../png/fig_ch1_poverty_var2.png", height=3.1, width=5.5)
...
figure_save_draft_png(fig_ch1_poverty_var3(), style_SAR_CCDR, "../png/fig_ch1_poverty_var3.png", height=3.1, width=5.5)
...
figure_save_draft_png(fig_ch1_population_pyramid(), style_SAR_CCDR, "../png/fig_ch1_population_pyramid.png", height=4.1, width=8.5)
...
```{r, echo=FALSE, message=FALSE, warning = FALSE, fig.height=8.1, fig.width=8.5, out.width=800, dpi=200}
  ...
  figure(
    ...
    plot = function(df, style = style_SAR_CCDR()) {
      ...
      p.frequency <- ggplot() +
        geom_rect(data=df.category, aes(ymax=ymax, ymin=ymin, xmax=3.5, xmin=2, fill=category), color = "white", size=1) +
        geom_rect(data=df.type, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3.5, fill=category), color = "white", size=1, alpha = 0.4) +
        geom_text(data = df.category, x=2.8, aes(y = labelPosition, label = label, vjust=vjust, family=style$family), size=3, lineheight = .9) +
        ...
        xlim(c(1, 5.1)) +
        scale_fill_manual(values = color_list)+
        annotate(geom = 'text', x = 1, y = 0, label = "Frequency", size=3.5) +
        labs(subtitle = "Frequency of natural disasters by type")+
        style$theme() +
        theme(legend.position = "none",
      ...
      p.deaths <- ggplot() +
        geom_rect(data=df.category, aes(ymax=ymax, ymin=ymin, xmax=3.5, xmin=2, fill=category), color = "white", size=1) +
        geom_rect(data=df.type, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3.5, fill=category), color = "white", size=1, alpha = 0.4) +
        geom_text(data = df.category, x=2.6, aes(y = labelPosition, label = label, vjust=vjust, family=style$family), size=3, lineheight = .9) +
        geom_text(data = df.type, x=4.1, aes(y = labelPosition, label = label, angle=angle, hjust=hjust, family=style$family), size=2, lineheight = .9, show.legend = F) + 
        coord_polar(theta="y") +
        xlim(c(1, 5.2)) +
        scale_fill_manual(values = color_list)+
        annotate(geom = 'text', x = 1, y = 0, label = "Deaths", size=3.5) +
        labs(subtitle = "Total deaths from natural disasters by type")+
        style$theme() +
        theme(legend.position = "none",
              plot.subtitle=element_text(hjust=0.5),
              ...
              axis.text.x = element_blank(),
              axis.text.y = element_blank(),
              plot.margin = margin(0,-5,-15,-5, unit = "mm"))
      ...
      p.damage <- ggplot() +
        geom_rect(data=df.category, aes(ymax=ymax, ymin=ymin, xmax=3.5, xmin=2, fill=category), color = "white", size=1) +
        geom_rect(data=df.type, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3.5, fill=category), color = "white", size=1, alpha = 0.4) +
        geom_text(data = df.category, x=2.6, aes(y = labelPosition, label = label, family=style$family), size=3, lineheight = .9, box.padding = unit(0, "lines"), 
                  show.legend = F) +
        geom_text(data = df.type, x=4.1, aes(y = labelPosition, label = label, angle=angle, hjust=hjust, family=style$family), size=2, lineheight = .9, show.legend = F) + 
        coord_polar(theta="y") +
        xlim(c(1, 5.1)) +
        scale_fill_manual(values = color_list)+
        annotate(geom = 'text', x = 1, y = 0, label = "Damage", size=3.5) +
        labs(subtitle = "Total damages from natural disasters by type, adjusted ('000 US$)")+
        style$theme() +
        theme(legend.position = "none",
              plot.subtitle=element_text(hjust=0.5),
      ...
      geom_rect(data=df.category, aes(ymax=ymax, ymin=ymin, xmax=3.5, xmin=2, fill=category), color = "white", size=1) +
      geom_rect(data=df.type, aes(ymax=ymax, ymin=ymin, xmax=4, xmin=3.5, fill=category), color = "white", size=1, alpha = 0.4) +
      geom_text(data = df.category, x=2.6, aes(y = labelPosition, label = label, vjust=vjust, family=style$family), size=3, lineheight = .9, box.padding = unit(0, "lines"), 
                      show.legend = F) +
      geom_text(data = df.type, x=4.1, aes(y = labelPosition, label = label, angle=angle, hjust=hjust, family=style$family), size=2, lineheight = .9, show.legend = F) + 
      coord_polar(theta="y") +
      xlim(c(1, 5.1)) +
      scale_fill_manual(values = color_list)+
      annotate(geom = 'text', x = 1, y = 0, label = "Affected", size=3.5) +
      ...
      theme(legend.position = "none",
            ...
            axis.text.x = element_blank(),
            axis.text.y = element_blank(),
            plot.margin = margin(0,1,-15, unit = "mm"))
...
figure_save_draft_png(fig_ch1_recent_natural_disaster_var2(), style_SAR_CCDR, "../png/fig_ch1_recent_natural_disaster_var2.png", height=8.1, width=8.5)
...
figure_save_draft_png(fig_ch1_GHG_by_sector_area(), style_SAR_CCDR, "../png/fig_ch1_GHG_by_sector_area.png", height=5.1, width=5.5)
```
...
fig_ch1_GHG_by_sector_pie_var1 <- function() {
  ...
  df$label <- paste0(df$Sector, "\n", round(df$percentage,1), "%")
  df$label <- c("Energy\n48.1% ", "Agriculture\n42.5%", "Industrial\nProcesses\n5.7%", "Waste\n2.1%", "Land-Use Change and Forestry\n1.6%")
  df$vjust <- c(0.5, 0.5, 0.85, 1, 0.0)
  df$hjust <- c(2.5, 0.5, 0.5, 0.5, 0.5)
  ...
  color_list = c(
    ...
    "Waste" = style$colors$purple,
    "Land-Use Change and Forestry" = style$colors$red,
    "Electricity/Heat" = "#05B2DC",   
    "Transportation" = "#0497C7",  
    "Manufacturing/Construction" = "#037BB1", 
    "Building" = "#025F9B", 
    "Fugitive Emissions" = "#004385",
    "Other Fuel Combustion" = "#033860")
  ...
  figure(
    ...
    plot = function(df, style = style_SAR_CCDR()) {
      ...
      geom_rect(data=df_energy, aes(ymax=ymax, ymin=ymin, xmax=4.5, xmin=4, fill=Sector), color = "white", size=1, alpha = 0.4) +
      ...
      theme(legend.position = "none",
            ...
            axis.text.x = element_blank(),
            axis.text.y = element_blank(),
            plot.margin = margin(-10,1,1,1, unit = "mm"))
    },
    aspect_ratio = 1,
    title = "Emissions are primarily from energy and agriculture, comprising 48% and 42% respectively, followed by Industrial Processes (6%), Waste (2.1%), and Land-Use Change and Forestry (1.6%).",
    subtitle = "Historical Country Greenhouse Gas Emissions (MtCO2e), 2018",
...
figure_save_draft_png(fig_ch1_GHG_by_gas_area(), style_SAR_CCDR, "../png/fig_ch1_GHG_by_gas_area.png", height=5.1, width=5.5)
```



```{r, echo=FALSE, message=FALSE, warning = FALSE, fig.height=3.1, fig.width=3.5, out.width=800, dpi=200}
...
figure_save_draft_png(fig_ch1_GHG_by_gas_pie(), style_SAR_CCDR, "../png/fig_ch1_GHG_by_gas_pie.png", height=3.1, width=3.5)
```
