...
## 3.1	Climate Change Commitments  



## 3.2	Existing Legal and Institutional Frameworks (National and Provincial)



## 3.3	Opportunities for Enhancing Climate Commitments 



## 3.4	Opportunities for Green Financing 

```{r, message=FALSE, warning = FALSE, fig.height=2.7, fig.width=6.5, out.width=800, dpi=200}
...
figure_save_draft_png(fig_ch3_actors_of_climate_finance(), style_atlas, "../drafts/fig_ch3_actors_of_climate_finance.png", height=2.7, width=6.5)
```
...
figure_save_draft_png(fig_ch3_climate_finance_by_sector(), style_atlas, "../drafts/fig_ch3_climate_finance_by_sector.png", height=2.7, width=6.5)

```



## 3.5	Strengthening Policy and Institutional Frameworks to Enable Climate Action 
