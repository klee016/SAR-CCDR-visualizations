...
## 2.1	Economy Wide Impacts of a Changing Climate 
...
figure_save_draft_png(fig_ch2_crop_yield(), style_atlas, "../drafts/fig_ch2_crop_yield.png", height=4.1, width=5.5)
```
...
figure_save_draft_png(fig_ch2_annual_expected_damage(), style_atlas, "../drafts/fig_ch2_annual_expected_damage.png", height=4.1, width=5.5)
```

## 2.2	Impacts of Climate Change on Poverty and Equity 

```{r, message=FALSE, warning = FALSE, fig.height=8.5, fig.width=8.5, out.width=800, dpi=200}
library(raster)
library(maps)
library(sf)
library(sp)
...
## 2.3	Climate Macroeconomic Models for Pakistan



## 2.4  Policy scenarios (till 2050)


```{r, message=FALSE, warning = FALSE, fig.height=7.5, fig.width=8.5, out.width=800, dpi=200}
